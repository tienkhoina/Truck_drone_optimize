...
set_target_properties(Coin::Cbc PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Cbc.lib"
  )

list(APPEND _cmake_import_check_targets Coin::Cbc )
list(APPEND _cmake_import_check_files_for_Coin::Cbc "${_IMPORT_PREFIX}/lib/Cbc.lib" )
...
set_target_properties(Coin::OsiCbc PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/OsiCbc.lib"
  )

list(APPEND _cmake_import_check_targets Coin::OsiCbc )
list(APPEND _cmake_import_check_files_for_Coin::OsiCbc "${_IMPORT_PREFIX}/lib/OsiCbc.lib" )
...
set_target_properties(Coin::CbcSolver PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/CbcSolver.lib"
  )

list(APPEND _cmake_import_check_targets Coin::CbcSolver )
list(APPEND _cmake_import_check_files_for_Coin::CbcSolver "${_IMPORT_PREFIX}/lib/CbcSolver.lib" )
