...
set_target_properties(Coin::Clp PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Clp.lib"
  )

list(APPEND _cmake_import_check_targets Coin::Clp )
list(APPEND _cmake_import_check_files_for_Coin::Clp "${_IMPORT_PREFIX}/lib/Clp.lib" )
...
set_target_properties(Coin::OsiClp PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/OsiClp.lib"
  )

list(APPEND _cmake_import_check_targets Coin::OsiClp )
list(APPEND _cmake_import_check_files_for_Coin::OsiClp "${_IMPORT_PREFIX}/lib/OsiClp.lib" )
...
set_target_properties(Coin::ClpSolver PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/ClpSolver.lib"
  )

list(APPEND _cmake_import_check_targets Coin::ClpSolver )
list(APPEND _cmake_import_check_files_for_Coin::ClpSolver "${_IMPORT_PREFIX}/lib/ClpSolver.lib" )
